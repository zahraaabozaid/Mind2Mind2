/*
  # Add Masterclasses and Session Summaries

  This migration adds two new feature tables:
  1. masterclasses - Group paid sessions hosted by experts
  2. masterclass_enrollments - Tracks who enrolled and their payment
  3. session_summaries - AI-generated summaries for sessions

  These tables do NOT touch any existing tables.
*/
...
-- Only the expert who created it can delete it
...
-- Experts can view enrollments for their masterclasses
...
-- System/webhook inserts enrollments (via service role)
CREATE POLICY "Authenticated users can insert their own enrollment"
  ON masterclass_enrollments FOR INSERT
  TO authenticated
  WITH CHECK (auth.uid() = user_id);

-- Users can update their own enrollment (for payment status updates)
...
CREATE TABLE IF NOT EXISTS session_summaries (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  -- Can reference either an exchange_request or a masterclass
...
-- ============================================================================
-- HELPER FUNCTION: Count enrollments for a masterclass
-- ============================================================================
...
-- ============================================================================
-- TRIGGER: Update masterclasses updated_at
-- ============================================================================
